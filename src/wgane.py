...
class WGANE:
    ...
    def __init__(self,
        ...
        summaries = [
            tf.summary.image("Generated image", self.fake_image, max_outputs = WGANE.max_summary_images),
            tf.summary.image("Real image", self.real_image, max_outputs = WGANE.max_summary_images),
            ...
            tf.summary.image("Input image", self.real_image, max_outputs = WGANE.max_summary_images),
            tf.summary.image("Recovered image", self.fake_image, max_outputs = WGANE.max_summary_images)
        ]
    ...
    def add_summary(self, sess, step, writer, timer) :
        ...
        :return:
        """
        data_batch = self.dataset.next_batch_real(WGANE.max_summary_images)
        z = self.dataset.next_batch_fake(WGANE.max_summary_images, self.z_size)
        eta = np.random.rand(WGANE.max_summary_images, 1, 1, 1)
